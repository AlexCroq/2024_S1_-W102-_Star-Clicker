...
public class TestUserDatabaseManager
{
    [Test]
    public void ParseUsers_WhenValidJsonResponse_ReturnsListOfUsers()
    {
        ...
        var userLoader = new UserDatabaseManager(); // Assuming UserLoader is your class containing parseUsers method
    ...
    public void TestConnectUser(){
        var userLoader = new UserDatabaseManager(); 
        string username = "admin";
        string password = "password";
        User expectedUser = new User { user_id = 1, username = username, password_hashed = password, star_dust = 0, friendsList = new List<int> { 1, 2, 3 }, starIDList = new List<int>  { 101, 102, 103 } };
        Assert.AreEqual(expectedUser, userLoader.ConnectUser(username,password));
    }
}
